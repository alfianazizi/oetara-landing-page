            ...
            <div className="flex flex-col w-full justify-center items-center h-full gap-10">
                <div>
                    <motion.div 
                        ...
                        transition={{ delay: 3 }} 
                        className='border border-[#EC1C24] py-16 lg:py-[7rem] mx-5 md:mx-0 lg:px-[5rem] rounded-[2rem]'
                    >
                    </motion.div>
                    <div className="-mt-[30%] md:-mt-[21%] flex justify-center gap-3 lg:gap-16 py-5 lg:py-[3rem] mx-5 px-5 lg:px-[5rem] rounded-[2rem]">
                        <motion.div 
                            ref={ref}
