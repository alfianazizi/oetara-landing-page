...
const OurTeam = ({handleJoinClick}) => {
    ...
    return (
        <div className="absolute inset-0 flex items-end bottom-[10%] lg:bottom-10 justify-center">
            <div className="bg-white flex justify-between flex-wrap lg:flex-nowrap p-4 lg:p-8 rounded-xl shadow-lg mx-4 max-w-3xl">
                ...
                <motion.h2 
                    ...
                    className="text-2xl md:text-[2.5rem] font-['montserrat-semibold'] text-[#C01C30] p-4"
                >
                    Join Our Team
                </motion.h2>
                <motion.p
                    ...
                    className="text-[#231F20] px-4 py-2"
                >
                ...
                <motion.button 
                    ...
                    className="bg-[#C01C30] border hover:border-[#C01C30] h-auto text-white px-8 py-3 rounded-full hover:bg-white hover:text-[#C01C30] font-['montserrat-bold'] transition-colors"
                >
                    Join Now
                </motion.button>
                </div>
